      ...
      <form @submit.prevent="submitPost">
        ...
        <div class="form-group mb-3">
          ...
          <select id="board" v-model="post.boardCode" class="form-control" required>
            ...
            <option value="travel">유머 게시판</option>
...
export default {
  ...
  methods: {
    ...
    fnEditPost() {
      ...
      if (this.id) {
        const apiUrl = `${this.$serverUrl}/api/travel/${boardCode}Board/detail/${this.id}`;
    ...
    getApiUrl() {
        const boardCode = this.$route.query.boardCode;
        this.boardCode = boardCode;
      if (this.post.boardCode === 'travel') {
        return `${this.$serverUrl}/api/travel/${boardCode}Board/create`;
      }
